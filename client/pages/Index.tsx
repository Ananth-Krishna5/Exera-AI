  ...
  const industries = [
    {
      ...
      count: "230",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/ea81a237091465d449054f6a8aff03c3aaf1ac20?width=1086",
    ...
    },
    {
      ...
      count: "223",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/895957d32f316bf6ff8cc360d3bc1888595baec9?width=1812",
    ...
    },
    {
      ...
      count: "12",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/202cdbc272a28cdfd20d275faaf8bd6bcc58367e?width=2138",
    ...
    },
    {
      ...
      count: "48",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/d8b4c62c6f90c19337ee55e15752bc2738cc0e53?width=1162",
    ...
    },
    {
      ...
      count: "36",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/60a222b2beda87bc9c4b9c80117b2c56aeb8e843?width=1154",
    ...
    },
    {
      ...
      count: "78",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/09d474616e6c744e598acb8117c648483dbffc68?width=5880",
    ...
    },
    {
      ...
      count: "19",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/e368bd19664f1429ff623ea95f3f68138bdbe27d?width=1580",
    ...
    },
    {
      ...
      count: "24",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/ea2bd6d59ae9878a7afac6ab56aea49b99cd861d?width=2080",
      ...
      <div className="relative h-[620px] bg-exerea-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-32">
          ...
          <div className="flex items-center gap-2 mb-6">
            <span className="text-white font-poppins font-semibold text-base underline cursor-pointer">
              Home
            </span>
                ...
                >
                  ...
                  {isHealthcare && (
                    <svg className="w-4 h-4" viewBox="0 0 17 18" fill="none">
                      ...
                      />
                      <path
                        d="M3.25012 9.25L6.75012 12.75L13.7501 5.25"
                        stroke="#36706E"
                        strokeLinecap="round"
                  ...
                  {!isHealthcare && !isSelected && filter !== "All" && (
                    <svg className="w-4 h-4" viewBox="0 0 17 18" fill="none">
                      ...
                      />
                      <path
                        d="M8.49996 2.97919V15.0209M14.5208 9.00002H2.47913"
                        stroke="#629091"
                        strokeWidth="0.708333"
                        strokeLinecap="round"
                      />
                    </svg>
                  )}
...
function IndustryCard({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-xl bg-gray-100 shadow-sm group cursor-pointer transition-transform hover:scale-[1.02] ${className}`}
    >
      {/* Background Image */}
